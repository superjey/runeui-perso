<head>
    <meta charset="utf-8">
    <title>Courgette l'Oustalet</title>
    ...
    <meta name="application-name" content="RuneAudio"> </head> <?php if (empty($this->uri(1)) OR ($this->uri(1) == 'playback')): ?> <body 
id="section-index"> <?php else: ?> <body id="section-<?=$this->section?>"> <?php endif ?> <!--
 /*
 ...
 */ --> <div id="menu-top">
    <div class="dropdown">
        <a id="menu-settings" class="dropdown-toggle" role="button" data-toggle="dropdown" data-target="#" href="#">MENU <i class="fa fa-bars 
dx"></i></a>
    ...
    <a class="home" href="/"><img src="<?=$this->asset('/img/logo.png')?>" class="logo" alt="RuneAudio"></a> </div> <div id="menu-bottom">
    <ul>
        <li id="open-panel-sx"><a href="/#panel-sx"<?=$this->uri(1, '', ' class="open-panel-sx" data-toggle="tab"')?>><i class="fa 
fa-music"></i> Library</a></li>
        <li id="open-playback"<?=$this->uri(1, '', ' class="active"')?>><a href="/#playback"<?=$this->uri(1, '', ' data-toggle="tab"')?>><i 
class="fa fa-play"></i> Playback</a></li>
        <li id="open-panel-dx"><a href="/#panel-dx"<?=$this->uri(1, '', ' class="open-panel-dx" data-toggle="tab"')?>><i class="fa 
fa-list"></i> Queue</a></li>
    </ul> </div>
